...
public class SwerveModuleFactory<DriveConfiguration, SteerConfiguration> {
    ...
    public SwerveModule create(ShuffleboardLayout container, DriveConfiguration driveConfiguration, SteerConfiguration steerConfiguration) {
        ...
        container.addNumber("theta", () -> steerContainer.getStateAngle());
        container.addNumber("vel_x", () -> driveController.getStateVelocity()*Math.cos(steerContainer.getStateAngle()));
        container.addNumber("vel_y", () -> driveController.getStateVelocity()*Math.sin(steerContainer.getStateAngle()));
