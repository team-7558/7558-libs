...
public class AHRSProtocol extends IMUProtocol {
  ...
  public static final short NAVX_CAPABILITY_FLAG_AHRSPOS_TS_RAW = 0x0800;
  ...
  public static final byte MSGID_AHRS_UPDATE = 'a';
  static final int AHRS_UPDATE_YAW_VALUE_INDEX = 4; /* Degrees.  Signed Hundredths */
  static final int AHRS_UPDATE_PITCH_VALUE_INDEX = 6; /* Degrees.  Signed Hundredeths */
  static final int AHRS_UPDATE_ROLL_VALUE_INDEX = 8; /* Degrees.  Signed Hundredths */
  static final int AHRS_UPDATE_HEADING_VALUE_INDEX = 10; /* Degrees.  Unsigned Hundredths */
  static final int AHRS_UPDATE_ALTITUDE_VALUE_INDEX = 12; /* Meters.   Signed 16:16 */
  static final int AHRS_UPDATE_FUSED_HEADING_VALUE_INDEX = 16; /* Degrees.  Unsigned Hundredths */
  static final int AHRS_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX = 18; /* Inst. G.  Signed Thousandths */
  static final int AHRS_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX = 20; /* Inst. G.  Signed Thousandths */
  static final int AHRS_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX = 22; /* Inst. G.  Signed Thousandths */
  static final int AHRS_UPDATE_CAL_MAG_X_VALUE_INDEX = 24; /* Int16 (Device Units) */
  static final int AHRS_UPDATE_CAL_MAG_Y_VALUE_INDEX = 26; /* Int16 (Device Units) */
  static final int AHRS_UPDATE_CAL_MAG_Z_VALUE_INDEX = 28; /* Int16 (Device Units) */
  static final int AHRS_UPDATE_CAL_MAG_NORM_RATIO_VALUE_INDEX =
      30; /* Ratio.  Unsigned Hundredths */
  static final int AHRS_UPDATE_CAL_MAG_SCALAR_VALUE_INDEX = 32; /* Coefficient. Signed 16:16 */
  static final int AHRS_UPDATE_MPU_TEMP_VAUE_INDEX = 36; /* Centigrade.  Signed Hundredths */
  static final int AHRS_UPDATE_RAW_MAG_X_VALUE_INDEX = 38; /* INT16 (Device Units */
  static final int AHRS_UPDATE_RAW_MAG_Y_VALUE_INDEX = 40; /* INT16 (Device Units */
  static final int AHRS_UPDATE_RAW_MAG_Z_VALUE_INDEX = 42; /* INT16 (Device Units */
  static final int AHRS_UPDATE_QUAT_W_VALUE_INDEX = 44; /* INT16 */
  static final int AHRS_UPDATE_QUAT_X_VALUE_INDEX = 46; /* INT16 */
  static final int AHRS_UPDATE_QUAT_Y_VALUE_INDEX = 48; /* INT16 */
  static final int AHRS_UPDATE_QUAT_Z_VALUE_INDEX = 50; /* INT16 */
  static final int AHRS_UPDATE_BARO_PRESSURE_VALUE_INDEX = 52; /* millibar.  Signed 16:16 */
  static final int AHRS_UPDATE_BARO_TEMP_VAUE_INDEX = 56; /* Centigrade.  Signed  Hundredths */
  static final int AHRS_UPDATE_OPSTATUS_VALUE_INDEX = 58; /* NAVX_OP_STATUS_XXX */
  static final int AHRS_UPDATE_SENSOR_STATUS_VALUE_INDEX = 59; /* NAVX_SENSOR_STATUS_XXX */
  static final int AHRS_UPDATE_CAL_STATUS_VALUE_INDEX = 60; /* NAVX_CAL_STATUS_XXX */
  static final int AHRS_UPDATE_SELFTEST_STATUS_VALUE_INDEX = 61; /* NAVX_SELFTEST_STATUS_XXX */
  ...
  // AHRSAndPositioning Update Packet (similar to AHRS, but removes magnetometer and adds
  // velocity/displacement) */

  public static final byte MSGID_AHRSPOS_UPDATE = 'p';
  static final int AHRSPOS_UPDATE_YAW_VALUE_INDEX = 4; /* Degrees.  Signed Hundredths */
  static final int AHRSPOS_UPDATE_PITCH_VALUE_INDEX = 6; /* Degrees.  Signed Hundredeths */
  static final int AHRSPOS_UPDATE_ROLL_VALUE_INDEX = 8; /* Degrees.  Signed Hundredths */
  static final int AHRSPOS_UPDATE_HEADING_VALUE_INDEX = 10; /* Degrees.  Unsigned Hundredths */
  static final int AHRSPOS_UPDATE_ALTITUDE_VALUE_INDEX = 12; /* Meters.   Signed 16:16 */
  static final int AHRSPOS_UPDATE_FUSED_HEADING_VALUE_INDEX =
      16; /* Degrees.  Unsigned Hundredths */
  static final int AHRSPOS_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX =
      18; /* Inst. G.  Signed Thousandths */
  static final int AHRSPOS_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX =
      20; /* Inst. G.  Signed Thousandths */
  static final int AHRSPOS_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX =
      22; /* Inst. G.  Signed Thousandths */
  static final int AHRSPOS_UPDATE_VEL_X_VALUE_INDEX = 24; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_UPDATE_VEL_Y_VALUE_INDEX = 28; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_UPDATE_VEL_Z_VALUE_INDEX = 32; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_UPDATE_DISP_X_VALUE_INDEX = 36; /* Signed 16:16, in meters */
  static final int AHRSPOS_UPDATE_DISP_Y_VALUE_INDEX = 40; /* Signed 16:16, in meters */
  static final int AHRSPOS_UPDATE_DISP_Z_VALUE_INDEX = 44; /* Signed 16:16, in meters */
  static final int AHRSPOS_UPDATE_QUAT_W_VALUE_INDEX = 48; /* INT16 */
  static final int AHRSPOS_UPDATE_QUAT_X_VALUE_INDEX = 50; /* INT16 */
  static final int AHRSPOS_UPDATE_QUAT_Y_VALUE_INDEX = 52; /* INT16 */
  static final int AHRSPOS_UPDATE_QUAT_Z_VALUE_INDEX = 54; /* INT16 */
  static final int AHRSPOS_UPDATE_MPU_TEMP_VAUE_INDEX = 56; /* Centigrade.  Signed Hundredths */
  static final int AHRSPOS_UPDATE_OPSTATUS_VALUE_INDEX = 58; /* NAVX_OP_STATUS_XXX */
  static final int AHRSPOS_UPDATE_SENSOR_STATUS_VALUE_INDEX = 59; /* NAVX_SENSOR_STATUS_XXX */
  static final int AHRSPOS_UPDATE_CAL_STATUS_VALUE_INDEX = 60; /* NAVX_CAL_STATUS_XXX */
  static final int AHRSPOS_UPDATE_SELFTEST_STATUS_VALUE_INDEX = 61; /* NAVX_SELFTEST_STATUS_XXX */
  ...
  public static final byte MSGID_AHRSPOS_TS_UPDATE = 't';
  static final int AHRSPOS_TS_UPDATE_YAW_VALUE_INDEX = 4; /* Degrees.  Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_PITCH_VALUE_INDEX = 8; /* Degrees.  Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_ROLL_VALUE_INDEX = 12; /* Degrees.  Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_HEADING_VALUE_INDEX = 16; /* Degrees.  Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_ALTITUDE_VALUE_INDEX = 20; /* Meters.   Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_FUSED_HEADING_VALUE_INDEX = 24; /* Degrees.  Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX = 28; /* Inst. G.  Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX = 32; /* Inst. G.  Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX = 36; /* Inst. G.  Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_VEL_X_VALUE_INDEX = 40; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_TS_UPDATE_VEL_Y_VALUE_INDEX = 44; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_TS_UPDATE_VEL_Z_VALUE_INDEX = 48; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_TS_UPDATE_DISP_X_VALUE_INDEX = 52; /* Signed 16:16, in meters */
  static final int AHRSPOS_TS_UPDATE_DISP_Y_VALUE_INDEX = 56; /* Signed 16:16, in meters */
  static final int AHRSPOS_TS_UPDATE_DISP_Z_VALUE_INDEX = 60; /* Signed 16:16, in meters */
  static final int AHRSPOS_TS_UPDATE_QUAT_W_VALUE_INDEX = 64; /* Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_QUAT_X_VALUE_INDEX = 68; /* Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_QUAT_Y_VALUE_INDEX = 72; /* Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_QUAT_Z_VALUE_INDEX = 76; /* Signed 16:16 */
  static final int AHRSPOS_TS_UPDATE_MPU_TEMP_VAUE_INDEX = 80; /* Centigrade.  Signed Hundredths */
  static final int AHRSPOS_TS_UPDATE_OPSTATUS_VALUE_INDEX = 82; /* NAVX_OP_STATUS_XXX */
  static final int AHRSPOS_TS_UPDATE_SENSOR_STATUS_VALUE_INDEX = 83; /* NAVX_SENSOR_STATUS_XXX */
  static final int AHRSPOS_TS_UPDATE_CAL_STATUS_VALUE_INDEX = 84; /* NAVX_CAL_STATUS_XXX */
  static final int AHRSPOS_TS_UPDATE_SELFTEST_STATUS_VALUE_INDEX =
      85; /* NAVX_SELFTEST_STATUS_XXX */
  static final int AHRSPOS_TS_UPDATE_TIMESTAMP_INDEX = 86; /* UINT32, Timestamp (milliseconds) */
  ...
  public static final byte MSGID_AHRSPOS_TS_RAW_UPDATE = 'u';
  static final int AHRSPOS_TS_RAW_UPDATE_YAW_VALUE_INDEX = 4; /* Signed 16:16.  Signed Hundredths */
  static final int AHRSPOS_TS_RAW_UPDATE_ROLL_VALUE_INDEX =
      8; /* Signed 16:16.  Signed Hundredths */
  static final int AHRSPOS_TS_RAW_UPDATE_PITCH_VALUE_INDEX =
      12; /* Signed 16:16.  Signed Hundredeths */
  static final int AHRSPOS_TS_RAW_UPDATE_HEADING_VALUE_INDEX =
      16; /* Signed 16:16.  Unsigned Hundredths */
  static final int AHRSPOS_TS_RAW_UPDATE_ALTITUDE_VALUE_INDEX = 20; /* Meters.   Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_FUSED_HEADING_VALUE_INDEX =
      24; /* Degrees.  Unsigned Hundredths */
  static final int AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX =
      28; /* Inst. G.  Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX =
      32; /* Inst. G.  Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX =
      36; /* Inst. G.  Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_VEL_X_VALUE_INDEX = 40; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_TS_RAW_UPDATE_VEL_Y_VALUE_INDEX = 44; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_TS_RAW_UPDATE_VEL_Z_VALUE_INDEX = 48; /* Signed 16:16, in meters/sec */
  static final int AHRSPOS_TS_RAW_UPDATE_DISP_X_VALUE_INDEX = 52; /* Signed 16:16, in meters */
  static final int AHRSPOS_TS_RAW_UPDATE_DISP_Y_VALUE_INDEX = 56; /* Signed 16:16, in meters */
  static final int AHRSPOS_TS_RAW_UPDATE_DISP_Z_VALUE_INDEX = 60; /* Signed 16:16, in meters */
  static final int AHRSPOS_TS_RAW_UPDATE_QUAT_W_VALUE_INDEX = 64; /* Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_QUAT_X_VALUE_INDEX = 68; /* Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_QUAT_Y_VALUE_INDEX = 72; /* Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_QUAT_Z_VALUE_INDEX = 76; /* Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_MPU_TEMP_VAUE_INDEX =
      80; /* Centigrade.  Signed Hundredths */
  static final int AHRSPOS_TS_RAW_UPDATE_OPSTATUS_VALUE_INDEX = 82; /* NAVX_OP_STATUS_XXX */
  static final int AHRSPOS_TS_RAW_UPDATE_SENSOR_STATUS_VALUE_INDEX =
      83; /* NAVX_SENSOR_STATUS_XXX */
  static final int AHRSPOS_TS_RAW_UPDATE_CAL_STATUS_VALUE_INDEX = 84; /* NAVX_CAL_STATUS_XXX */
  static final int AHRSPOS_TS_RAW_UPDATE_SELFTEST_STATUS_VALUE_INDEX =
      85; /* NAVX_SELFTEST_STATUS_XXX */
  static final int AHRSPOS_TS_RAW_UPDATE_TIMESTAMP_INDEX =
      86; /* UINT32 Timestamp, in milliseconds */
  static final int AHRSPOS_TS_RAW_UPDATE_GYRO_X_VALUE_INDEX =
      90; /* INT16, in device units (scaled by FSR) */
  static final int AHRSPOS_TS_RAW_UPDATE_GYRO_Y_VALUE_INDEX =
      92; /* INT16, in device units (scaled by FSR) */
  static final int AHRSPOS_TS_RAW_UPDATE_GYRO_Z_VALUE_INDEX =
      94; /* INT16, in device units (scaled by FSR) */
  static final int AHRSPOS_TS_RAW_UPDATE_ACC_X_VALUE_INDEX =
      96; /* INT16, in device units (scaled by FSR) */
  static final int AHRSPOS_TS_RAW_UPDATE_ACC_Y_VALUE_INDEX =
      98; /* INT16, in device units (scaled by FSR) */
  static final int AHRSPOS_TS_RAW_UPDATE_ACC_Z_VALUE_INDEX =
      100; /* INT16, in device units (scaled by FSR) */
  static final int AHRSPOS_TS_RAW_UPDATE_LAST_SAMPLE_DELTA_SEC_INDEX = 104; /* Signed 16:16 */
  static final int AHRSPOS_TS_RAW_UPDATE_GYRO_BIAS_UPDATED_BOOL_INDEX =
      108; /* INT16, 0 if false, otherwise true */
  ...
  // request type)
  public static final byte MSGID_DATA_REQUEST = 'D';
  ...
  public static final byte MSGID_DATA_SET_RESPONSE = 'v';
  ...
  public static final byte MSGID_INTEGRATION_CONTROL_CMD = 'I';
  ...
  public static final byte MSGID_INTEGRATION_CONTROL_RESP = 'j';
  ...
  public static final byte MSGID_MAG_CAL_CMD = 'M';
  static final int MAG_CAL_DATA_ACTION_VALUE_INDEX = 4;
  static final int MAG_X_BIAS_VALUE_INDEX = 5; /* signed short */
  static final int MAG_Y_BIAS_VALUE_INDEX = 7;
  static final int MAG_Z_BIAS_VALUE_INDEX = 9;
  static final int MAG_XFORM_1_1_VALUE_INDEX = 11; /* signed 16:16 */
  ...
  public static final byte MSGID_FUSION_TUNING_CMD = 'T';
  ...
  public static final byte MSGID_BOARD_IDENTITY_RESPONSE = 'i';
  ...
  public static final int MAX_BINARY_MESSAGE_LENGTH = AHRSPOS_TS_RAW_UPDATE_MESSAGE_LENGTH;
  ...
  public static class AHRSPosTSRawUpdate extends AHRSPosTSUpdate {
    public short raw_gyro_x; // Device units, scaled by FSR
    public short raw_gyro_y; // Device units, scaled by FSR
    public short raw_gyro_z; // Device units, scaled by FSR
    public short accel_x; // Device units, scaled by FSR
    public short accel_y; // Device units, scaled by FSR
    public short accel_z; // Device units, scaled by FSR
    public float delta_t_sec; // last sample period, as a portion of a second
    public boolean
        gyro_bias_updated; // true if gyro bias was updated (e.g., when still) during last sample
  }
  ;
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
      ...
      u.pitch =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRS_UPDATE_ROLL_VALUE_INDEX); /* FIXME */
      u.roll =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRS_UPDATE_PITCH_VALUE_INDEX); /* FIXME */
      u.compass_heading =
          decodeProtocolUnsignedHundredthsFloat(buffer, offset + AHRS_UPDATE_HEADING_VALUE_INDEX);
      u.altitude = decodeProtocol1616Float(buffer, offset + AHRS_UPDATE_ALTITUDE_VALUE_INDEX);
      u.fused_heading =
          decodeProtocolUnsignedHundredthsFloat(
              buffer, offset + AHRS_UPDATE_FUSED_HEADING_VALUE_INDEX);
      u.linear_accel_x =
          decodeProtocolSignedThousandthsFloat(
              buffer, offset + AHRS_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX);
      u.linear_accel_y =
          decodeProtocolSignedThousandthsFloat(
              buffer, offset + AHRS_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX);
      u.linear_accel_z =
          decodeProtocolSignedThousandthsFloat(
              buffer, offset + AHRS_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX);
      ...
      u.mag_field_norm_ratio =
          decodeProtocolUnsignedHundredthsFloat(
              buffer, offset + AHRS_UPDATE_CAL_MAG_NORM_RATIO_VALUE_INDEX);
      u.mag_field_norm_scalar =
          decodeProtocol1616Float(buffer, offset + AHRS_UPDATE_CAL_MAG_SCALAR_VALUE_INDEX);
      u.mpu_temp =
          decodeProtocolSignedHundredthsFloat(buffer, offset + AHRS_UPDATE_MPU_TEMP_VAUE_INDEX);
      ...
      u.quat_w =
          ((float) decodeBinaryInt16(buffer, offset + AHRS_UPDATE_QUAT_W_VALUE_INDEX) / 16384.0f);
      u.quat_x =
          ((float) decodeBinaryInt16(buffer, offset + AHRS_UPDATE_QUAT_X_VALUE_INDEX) / 16384.0f);
      u.quat_y =
          ((float) decodeBinaryInt16(buffer, offset + AHRS_UPDATE_QUAT_Y_VALUE_INDEX) / 16384.0f);
      u.quat_z =
          ((float) decodeBinaryInt16(buffer, offset + AHRS_UPDATE_QUAT_Z_VALUE_INDEX) / 16384.0f);
      u.barometric_pressure =
          decodeProtocol1616Float(buffer, offset + AHRS_UPDATE_BARO_PRESSURE_VALUE_INDEX);
      u.baro_temp =
          decodeProtocolSignedHundredthsFloat(buffer, offset + AHRS_UPDATE_BARO_TEMP_VAUE_INDEX);
      u.op_status = buffer[offset + AHRS_UPDATE_OPSTATUS_VALUE_INDEX];
      u.sensor_status = buffer[offset + AHRS_UPDATE_SENSOR_STATUS_VALUE_INDEX];
      u.cal_status = buffer[offset + AHRS_UPDATE_CAL_STATUS_VALUE_INDEX];
      u.selftest_status = buffer[offset + AHRS_UPDATE_SELFTEST_STATUS_VALUE_INDEX];
  ...
  public static int decodeAHRSPosUpdate(byte[] buffer, int offset, int length, AHRSPosUpdate u) {
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
      ...
      u.pitch =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRSPOS_UPDATE_ROLL_VALUE_INDEX); /* FIXME */
      u.roll =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRSPOS_UPDATE_PITCH_VALUE_INDEX); /* FIXME */
      u.compass_heading =
          decodeProtocolUnsignedHundredthsFloat(
              buffer, offset + AHRSPOS_UPDATE_HEADING_VALUE_INDEX);
      u.altitude = decodeProtocol1616Float(buffer, offset + AHRSPOS_UPDATE_ALTITUDE_VALUE_INDEX);
      u.fused_heading =
          decodeProtocolUnsignedHundredthsFloat(
              buffer, offset + AHRSPOS_UPDATE_FUSED_HEADING_VALUE_INDEX);
      u.linear_accel_x =
          decodeProtocolSignedThousandthsFloat(
              buffer, offset + AHRSPOS_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX);
      u.linear_accel_y =
          decodeProtocolSignedThousandthsFloat(
              buffer, offset + AHRSPOS_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX);
      u.linear_accel_z =
          decodeProtocolSignedThousandthsFloat(
              buffer, offset + AHRSPOS_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX);
      ...
      u.mpu_temp =
          decodeProtocolSignedHundredthsFloat(buffer, offset + AHRSPOS_UPDATE_MPU_TEMP_VAUE_INDEX);
      /* AHRSPosUpdate:  Quaternions are signed int (16-bit resolution); divide by 16384 to yield +/- 2 radians */
      u.quat_w =
          ((float) decodeBinaryInt16(buffer, offset + AHRSPOS_UPDATE_QUAT_W_VALUE_INDEX)
              / 16384.0f);
      u.quat_x =
          ((float) decodeBinaryInt16(buffer, offset + AHRSPOS_UPDATE_QUAT_X_VALUE_INDEX)
              / 16384.0f);
      u.quat_y =
          ((float) decodeBinaryInt16(buffer, offset + AHRSPOS_UPDATE_QUAT_Y_VALUE_INDEX)
              / 16384.0f);
      u.quat_z =
          ((float) decodeBinaryInt16(buffer, offset + AHRSPOS_UPDATE_QUAT_Z_VALUE_INDEX)
              / 16384.0f);
      u.op_status = buffer[offset + AHRSPOS_UPDATE_OPSTATUS_VALUE_INDEX];
      u.sensor_status = buffer[offset + AHRSPOS_UPDATE_SENSOR_STATUS_VALUE_INDEX];
      u.cal_status = buffer[offset + AHRSPOS_UPDATE_CAL_STATUS_VALUE_INDEX];
      u.selftest_status = buffer[offset + AHRSPOS_UPDATE_SELFTEST_STATUS_VALUE_INDEX];
      return AHRSPOS_UPDATE_MESSAGE_LENGTH;
    }
    return 0;
  }

  public static int decodeAHRSPosTSUpdate(
      byte[] buffer, int offset, int length, AHRSPosTSUpdate u) {
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
      ...
      u.pitch =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_ROLL_VALUE_INDEX); /* FIXME */
      u.roll =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_PITCH_VALUE_INDEX); /* FIXME */
      u.compass_heading =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_HEADING_VALUE_INDEX);
      u.altitude = decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_ALTITUDE_VALUE_INDEX);
      u.fused_heading =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_FUSED_HEADING_VALUE_INDEX);
      u.linear_accel_x =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX);
      u.linear_accel_y =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX);
      u.linear_accel_z =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX);
      ...
      u.mpu_temp =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRSPOS_TS_UPDATE_MPU_TEMP_VAUE_INDEX);
      /* AHRSPosTSUpdate:  Quaternions are 16.16 format (32-bit resolution). */
      u.quat_w =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_QUAT_W_VALUE_INDEX) / 16384.0f;
      u.quat_x =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_QUAT_X_VALUE_INDEX) / 16384.0f;
      u.quat_y =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_QUAT_Y_VALUE_INDEX) / 16384.0f;
      u.quat_z =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_QUAT_Z_VALUE_INDEX) / 16384.0f;
      u.op_status = buffer[offset + AHRSPOS_TS_UPDATE_OPSTATUS_VALUE_INDEX];
      u.sensor_status = buffer[offset + AHRSPOS_TS_UPDATE_SENSOR_STATUS_VALUE_INDEX];
      u.cal_status = buffer[offset + AHRSPOS_TS_UPDATE_CAL_STATUS_VALUE_INDEX];
      u.selftest_status = buffer[offset + AHRSPOS_TS_UPDATE_SELFTEST_STATUS_VALUE_INDEX];
  ...
  public static int decodeAHRSPosTSRawUpdate(
      byte[] buffer, int offset, int length, AHRSPosTSRawUpdate u) {
    if (length < AHRSPOS_TS_RAW_UPDATE_MESSAGE_LENGTH) {
      return 0;
    }
    int msg_len =
        (((int) buffer[offset + 2]) & 0xFF); // Length is > 127, so treat as unsigned value
    if ((buffer[offset + 0] == PACKET_START_CHAR)
        && (buffer[offset + 1] == BINARY_PACKET_INDICATOR_CHAR)
      ...
      u.yaw = decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_YAW_VALUE_INDEX);
      u.pitch =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_ROLL_VALUE_INDEX); /* FIXME */
      u.roll =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_PITCH_VALUE_INDEX); /* FIXME */
      u.compass_heading =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_HEADING_VALUE_INDEX);
      u.altitude =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_ALTITUDE_VALUE_INDEX);
      u.fused_heading =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_FUSED_HEADING_VALUE_INDEX);
      u.linear_accel_x =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX);
      u.linear_accel_y =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX);
      u.linear_accel_z =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX);
      u.vel_x = decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_VEL_X_VALUE_INDEX);
      u.vel_y = decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_VEL_Y_VALUE_INDEX);
      u.vel_z = decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_VEL_Z_VALUE_INDEX);
      u.disp_x = decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_DISP_X_VALUE_INDEX);
      u.disp_y = decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_DISP_Y_VALUE_INDEX);
      u.disp_z = decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_DISP_Z_VALUE_INDEX);
      u.mpu_temp =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_MPU_TEMP_VAUE_INDEX);
      /* AHRSPosTSUpdate:  Quaternions are 16.16 format (32-bit resolution). */
      u.quat_w =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_QUAT_W_VALUE_INDEX)
              / 16384.0f;
      u.quat_x =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_QUAT_X_VALUE_INDEX)
              / 16384.0f;
      u.quat_y =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_QUAT_Y_VALUE_INDEX)
              / 16384.0f;
      u.quat_z =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_RAW_UPDATE_QUAT_Z_VALUE_INDEX)
              / 16384.0f;
      u.op_status = buffer[offset + AHRSPOS_TS_RAW_UPDATE_OPSTATUS_VALUE_INDEX];
      u.sensor_status = buffer[offset + AHRSPOS_TS_RAW_UPDATE_SENSOR_STATUS_VALUE_INDEX];
      u.cal_status = buffer[offset + AHRSPOS_TS_RAW_UPDATE_CAL_STATUS_VALUE_INDEX];
      u.selftest_status = buffer[offset + AHRSPOS_TS_RAW_UPDATE_SELFTEST_STATUS_VALUE_INDEX];
      u.timestamp = decodeBinaryUint32(buffer, offset + AHRSPOS_TS_RAW_UPDATE_TIMESTAMP_INDEX);

      u.raw_gyro_x = decodeBinaryInt16(buffer, offset + AHRSPOS_TS_RAW_UPDATE_GYRO_X_VALUE_INDEX);
      u.raw_gyro_y = decodeBinaryInt16(buffer, offset + AHRSPOS_TS_RAW_UPDATE_GYRO_Y_VALUE_INDEX);
      u.raw_gyro_z = decodeBinaryInt16(buffer, offset + AHRSPOS_TS_RAW_UPDATE_GYRO_Z_VALUE_INDEX);
      u.accel_x = decodeBinaryInt16(buffer, offset + AHRSPOS_TS_RAW_UPDATE_ACC_X_VALUE_INDEX);
      u.accel_y = decodeBinaryInt16(buffer, offset + AHRSPOS_TS_RAW_UPDATE_ACC_Y_VALUE_INDEX);
      u.accel_z = decodeBinaryInt16(buffer, offset + AHRSPOS_TS_RAW_UPDATE_ACC_Z_VALUE_INDEX);
      u.delta_t_sec =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_LAST_SAMPLE_DELTA_SEC_INDEX);
      u.gyro_bias_updated =
          ((decodeBinaryInt16(buffer, offset + AHRSPOS_TS_RAW_UPDATE_GYRO_BIAS_UPDATED_BOOL_INDEX)
                  != 0)
              ? true
              : false);
  ...
  public static int encodeMagCalDataSetRequest(byte[] buffer, MagCalData d) {
    ...
    for (int i = 0; i < 3; i++) {
      encodeBinaryInt16(d.mag_bias[i], buffer, MAG_X_BIAS_VALUE_INDEX + (i * 2));
    }
    for (int i = 0; i < 3; i++) {
      for (int j = 0; j < 3; j++) {
        encodeProtocol1616Float(
            d.mag_xform[i][j], buffer, MAG_XFORM_1_1_VALUE_INDEX + (i * 6) + (j * 2));
      }
    }
    encodeProtocol1616Float(
        d.earth_mag_field_norm, buffer, MAG_CAL_EARTH_MAG_FIELD_NORM_VALUE_INDEX);
    // Footer
  ...
  public static int decodeMagCalDataGetResponse(
      byte[] buffer, int offset, int length, MagCalData d) {
    if (length < MAG_CAL_CMD_MESSAGE_LENGTH) return 0;
    if ((buffer[offset + 0] == PACKET_START_CHAR)
        && (buffer[offset + 1] == BINARY_PACKET_INDICATOR_CHAR)
        && (buffer[offset + 2] == MAG_CAL_CMD_MESSAGE_LENGTH - 2)
        && (buffer[offset + 3] == MSGID_MAG_CAL_CMD)) {
      if (!verifyChecksum(buffer, offset, MAG_CAL_CMD_MESSAGE_CHECKSUM_INDEX)) return 0;

      d.action = buffer[offset + MAG_CAL_DATA_ACTION_VALUE_INDEX];
      for (int i = 0; i < 3; i++) {
        d.mag_bias[i] = decodeBinaryInt16(buffer, offset + MAG_X_BIAS_VALUE_INDEX + (i * 2));
      }
      for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
          d.mag_xform[i][j] =
              decodeProtocol1616Float(
                  buffer, offset + MAG_XFORM_1_1_VALUE_INDEX + (i * 6) + (j * 2));
        }
      }
      d.earth_mag_field_norm =
          decodeProtocol1616Float(buffer, offset + MAG_CAL_EARTH_MAG_FIELD_NORM_VALUE_INDEX);
      return MAG_CAL_CMD_MESSAGE_LENGTH;
    }
    return 0;
  }
  ...
  public static int encodeTuningVarSetRequest(byte[] buffer, TuningVar r) {
    ...
    // Footer
    encodeTermination(
        buffer, FUSION_TUNING_CMD_MESSAGE_LENGTH, FUSION_TUNING_CMD_MESSAGE_LENGTH - 4);
  ...
  public static int decodeTuningVarGetResponse(byte[] buffer, int offset, int length, TuningVar r) {
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
        && (buffer[offset + 1] == BINARY_PACKET_INDICATOR_CHAR)
        && (buffer[offset + 2] == FUSION_TUNING_CMD_MESSAGE_LENGTH - 2)
        && (buffer[offset + 3] == MSGID_FUSION_TUNING_CMD)) {
      if (!verifyChecksum(buffer, offset, FUSION_TUNING_CMD_MESSAGE_CHECKSUM_INDEX)) return 0;

      // Data
      r.action = buffer[offset + FUSION_TUNING_DATA_ACTION_VALUE_INDEX];
      r.var_id = buffer[offset + FUSION_TUNING_CMD_VAR_ID_VALUE_INDEX];
      r.value = decodeProtocol1616Float(buffer, offset + FUSION_TUNING_CMD_VAR_VALUE_INDEX);
      return FUSION_TUNING_CMD_MESSAGE_LENGTH;
    }
    return 0;
  }
  ...
  public static int encodeIntegrationControlCmd(byte[] buffer, IntegrationControl u) {
    ...
    // Footer
    encodeTermination(
        buffer, INTEGRATION_CONTROL_CMD_MESSAGE_LENGTH, INTEGRATION_CONTROL_CMD_MESSAGE_LENGTH - 4);
    return INTEGRATION_CONTROL_CMD_MESSAGE_LENGTH;
  }

  public static int decodeIntegrationControlResponse(
      byte[] buffer, int offset, int length, IntegrationControl u) {
    if (length < INTEGRATION_CONTROL_RESP_MESSAGE_LENGTH) return 0;
    if ((buffer[offset + 0] == PACKET_START_CHAR)
        && (buffer[offset + 1] == BINARY_PACKET_INDICATOR_CHAR)
        && (buffer[offset + 2] == INTEGRATION_CONTROL_RESP_MESSAGE_LENGTH - 2)
      ...
      // Data
      u.action = buffer[offset + INTEGRATION_CONTROL_RESP_ACTION_INDEX];
      u.parameter = decodeBinaryUint32(buffer, offset + INTEGRATION_CONTROL_RESP_PARAMETER_INDEX);
  ...
  public static int decodeDataSetResponse(
      byte[] buffer, int offset, int length, DataSetResponse d) {
    if (length < DATA_SET_RESPONSE_MESSAGE_LENGTH) return 0;
    if ((buffer[offset + 0] == PACKET_START_CHAR)
        && (buffer[offset + 1] == BINARY_PACKET_INDICATOR_CHAR)
        && (buffer[offset + 2] == DATA_SET_RESPONSE_MESSAGE_LENGTH - 2)
        && (buffer[offset + 3] == MSGID_DATA_SET_RESPONSE)) {
      if (!verifyChecksum(buffer, offset, DATA_SET_RESPONSE_MESSAGE_CHECKSUM_INDEX)) return 0;

      d.data_type = buffer[offset + DATA_SET_RESPONSE_DATATYPE_VALUE_INDEX];
      d.var_id = buffer[offset + DATA_SET_RESPONSE_VARID_VALUE_INDEX];
      d.status = buffer[offset + DATA_SET_RESPONSE_STATUS_VALUE_INDEX];
  ...
  public static int decodeBoardIDGetResponse(byte[] buffer, int offset, int length, BoardID id) {
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
        && (buffer[offset + 1] == BINARY_PACKET_INDICATOR_CHAR)
        && (buffer[offset + 2] == BOARD_IDENTITY_RESPONSE_MESSAGE_LENGTH - 2)
      ...
      id.type = buffer[offset + BOARD_IDENTITY_BOARDTYPE_VALUE_INDEX];
      id.hw_rev = buffer[offset + BOARD_IDENTITY_HWREV_VALUE_INDEX];
      id.fw_ver_major = buffer[offset + BOARD_IDENTITY_FW_VER_MAJOR];
      id.fw_ver_minor = buffer[offset + BOARD_IDENTITY_FW_VER_MINOR];
      id.fw_revision =
          decodeBinaryUint16(buffer, offset + BOARD_IDENTITY_FW_VER_REVISION_VALUE_INDEX);
      for (int i = 0; i < 12; i++) {
        id.unique_id[i] = buffer[offset + BOARD_IDENTITY_UNIQUE_ID_0 + i];
      }
